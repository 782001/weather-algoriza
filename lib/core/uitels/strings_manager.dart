class AppStrings {
  ...
  static const onBoardingSubTitle1 =
      "Tut core is an awesome flutter application using clean architecture #1";
  static const onBoardingSubTitle2 =
      "Tut core is an awesome flutter application using clean architecture #2";
  static const onBoardingSubTitle3 =
      "Tut core is an awesome flutter application using clean architecture #3";
  static const onBoardingSubTitle4 =
      "Tut core is an awesome flutter application using clean architecture #4";
